...
const getListaDeEstados = function () {
   let listaDeEstadosJSON = { uf: [], quantidade: 0 }

   estadosCidades.estados.forEach(function (estado) {
      listaDeEstadosJSON.uf.push(estado.sigla)
      listaDeEstadosJSON.quantidade++
   })
...
const getCidades = function (sigla) {
   ...
   estadosCidades.estados.forEach(function (estado) {
      if (siglaEstado == estado.sigla) {
         ...
         cidadesJSON.uf = estado.sigla
         cidadesJSON.descricao = estado.nome
         cidadesJSON.quantidade_cidades = estado.cidades.length
